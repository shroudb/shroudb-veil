...
- [x] **F-veil-7 (L)** — `index_manager.rs:536,552` silently swallows posting-list errors. Test: `debt_7_inv_lookup_must_surface_corrupt_posting_list` @ `shroudb-veil-engine/src/index_manager.rs`.
